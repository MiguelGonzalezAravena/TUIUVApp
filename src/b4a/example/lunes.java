...
public class lunes extends Activity implements B4AActivity{
	public static lunes mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.lunes");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (lunes).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.lunes");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.lunes", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (lunes) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (lunes) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (lunes) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
if (_firsttime) { 
 //BA.debugLineNum = 85;BA.debugLine="hc.Initialize(\"hc\")";
_hc.Initialize("hc");
 };
 //BA.debugLineNum = 87;BA.debugLine="Activity.LoadLayout(\"Dia_Horario\")";
mostCurrent._activity.LoadLayout("Dia_Horario",mostCurrent.activityBA);
 //BA.debugLineNum = 88;BA.debugLine="Label1.Text = \"Lunes\"";
mostCurrent._label1.setText((Object)("Lunes"));
 //BA.debugLineNum = 89;BA.debugLine="Button8.Text = \" - \"";
mostCurrent._button8.setText((Object)(" - "));
 //BA.debugLineNum = 90;BA.debugLine="Button9.Text = \" - \"";
mostCurrent._button9.setText((Object)(" - "));
 //BA.debugLineNum = 91;BA.debugLine="Button10.Text = \" - \"";
mostCurrent._button10.setText((Object)(" - "));
 //BA.debugLineNum = 92;BA.debugLine="Button11.Text = \" - \"";
mostCurrent._button11.setText((Object)(" - "));
 //BA.debugLineNum = 93;BA.debugLine="Button12.Text = \" - \"";
mostCurrent._button12.setText((Object)(" - "));
 //BA.debugLineNum = 94;BA.debugLine="Button13.Text = \" - \"";
mostCurrent._button13.setText((Object)(" - "));
 //BA.debugLineNum = 95;BA.debugLine="Button14.Text = \" - \"";
mostCurrent._button14.setText((Object)(" - "));
 //BA.debugLineNum = 96;BA.debugLine="Button1.Color = Colors.RGB(0, 82, 155)";
mostCurrent._button1.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (82),(int) (155)));
 //BA.debugLineNum = 97;BA.debugLine="Button2.Color = Colors.RGB(0, 82, 155)";
mostCurrent._button2.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (82),(int) (155)));
 //BA.debugLineNum = 98;BA.debugLine="Button3.Color = Colors.RGB(0, 82, 155)";
mostCurrent._button3.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (82),(int) (155)));
 //BA.debugLineNum = 99;BA.debugLine="Button4.Color = Colors.RGB(0, 82, 155)";
mostCurrent._button4.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (82),(int) (155)));
 //BA.debugLineNum = 100;BA.debugLine="Button5.Color = Colors.RGB(0, 82, 155)";
mostCurrent._button5.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (82),(int) (155)));
 //BA.debugLineNum = 101;BA.debugLine="Button6.Color = Colors.RGB(0, 82, 155)";
mostCurrent._button6.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (82),(int) (155)));
 //BA.debugLineNum = 102;BA.debugLine="Button7.Color = Colors.RGB(0, 82, 155)";
mostCurrent._button7.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (82),(int) (155)));
 //BA.debugLineNum = 103;BA.debugLine="Select Case DiaHoy";
switch (BA.switchObjectToInt(mostCurrent._diahoy,"Lunes")) {
case 0:
 //BA.debugLineNum = 105;BA.debugLine="If Hora = 8 AND Minutos >= 30 OR Hora = 9 Then";
if (_hora==8 && _minutos>=30 || _hora==9) { 
 //BA.debugLineNum = 106;BA.debugLine="Button1.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button1.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 108;BA.debugLine="Button2.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button2.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 110;BA.debugLine="Button3.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button3.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 112;BA.debugLine="Button4.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button4.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 114;BA.debugLine="Button5.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button5.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 116;BA.debugLine="Button6.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button6.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 118;BA.debugLine="Button7.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button7.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 };
 break;
}
;
 //BA.debugLineNum = 121;BA.debugLine="Dim req As HttpRequest";
_req = new anywheresoftware.b4a.http.HttpClientWrapper.HttpUriRequestWrapper();
 //BA.debugLineNum = 122;BA.debugLine="Dim all As String";
_all = "";
 //BA.debugLineNum = 123;BA.debugLine="all = \"dia=0&user=\" & Main.run & \"&passwd=\" & Mai";
_all = "dia=0&user="+mostCurrent._main._run+"&passwd="+mostCurrent._main._passwd;
 //BA.debugLineNum = 124;BA.debugLine="req.InitializePost2(\"http://tui.miguelgonzaleza.c";
_req.InitializePost2("http://tui.miguelgonzaleza.com/api.php?action=horario",_all.getBytes("UTF8"));
 //BA.debugLineNum = 125;BA.debugLine="hc.Execute(req, 1)";
...
public static String  _hc_responseerror(String _reason,int _statuscode,int _taskid) throws Exception{
 //BA.debugLineNum = 42;BA.debugLine="Sub hc_ResponseError(Reason As String, StatusCode";
 //BA.debugLineNum = 43;BA.debugLine="Msgbox(Reason, \"error\")";
...
anywheresoftware.b4a.objects.collections.Map _map2 = null;
 //BA.debugLineNum = 46;BA.debugLine="Sub hc_ResponseSuccess(Response As HttpResponse, T";
 //BA.debugLineNum = 47;BA.debugLine="Dim res As String";
_res = "";
 //BA.debugLineNum = 48;BA.debugLine="Dim bloque, codigo, sala As String";
_bloque = "";
_codigo = "";
_sala = "";
 //BA.debugLineNum = 49;BA.debugLine="Dim Map1 As List";
_map1 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 50;BA.debugLine="Dim Map2 As Map";
_map2 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 51;BA.debugLine="res = Response.GetString(\"UTF8\")";
_res = _response.GetString("UTF8");
 //BA.debugLineNum = 52;BA.debugLine="JSON.Initialize(res)";
mostCurrent._json.Initialize(_res);
 //BA.debugLineNum = 53;BA.debugLine="Map1 = JSON.NextArray";
_map1 = mostCurrent._json.NextArray();
 //BA.debugLineNum = 54;BA.debugLine="If Map1.Size = 0 Then";
if (_map1.getSize()==0) { 
 //BA.debugLineNum = 55;BA.debugLine="Msgbox(\"¡Este día no tienes clases!\", \"¡Atención";
anywheresoftware.b4a.keywords.Common.Msgbox("¡Este día no tienes clases!","¡Atención!",mostCurrent.activityBA);
 };
 //BA.debugLineNum = 57;BA.debugLine="For i = 0 To Map1.Size-1";
{
final int step42 = 1;
final int limit42 = (int) (_map1.getSize()-1);
for (_i = (int) (0); (step42 > 0 && _i <= limit42) || (step42 < 0 && _i >= limit42); _i = ((int)(0 + _i + step42))) {
 //BA.debugLineNum = 58;BA.debugLine="Map2 = Map1.Get(i)";
_map2.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_map1.Get(_i)));
 //BA.debugLineNum = 59;BA.debugLine="bloque = Map2.Get(\"bloque\")";
_bloque = BA.ObjectToString(_map2.Get((Object)("bloque")));
 //BA.debugLineNum = 60;BA.debugLine="codigo = Map2.Get(\"codigo\")";
_codigo = BA.ObjectToString(_map2.Get((Object)("codigo")));
 //BA.debugLineNum = 61;BA.debugLine="sala = Map2.Get(\"sala\")";
_sala = BA.ObjectToString(_map2.Get((Object)("sala")));
 //BA.debugLineNum = 62;BA.debugLine="Select Case bloque";
...
case 0:
 //BA.debugLineNum = 64;BA.debugLine="Button8.Text = \"[\" & codigo & \"] \" & sala";
mostCurrent._button8.setText((Object)("["+_codigo+"] "+_sala));
 break;
case 1:
 //BA.debugLineNum = 66;BA.debugLine="Button9.Text = \"[\" & codigo & \"] \" & sala";
mostCurrent._button9.setText((Object)("["+_codigo+"] "+_sala));
 break;
case 2:
 //BA.debugLineNum = 68;BA.debugLine="Button10.Text = \"[\" & codigo & \"] \" & sala";
mostCurrent._button10.setText((Object)("["+_codigo+"] "+_sala));
 break;
case 3:
 //BA.debugLineNum = 70;BA.debugLine="Button11.Text = \"[\" & codigo & \"] \" & sala";
mostCurrent._button11.setText((Object)("["+_codigo+"] "+_sala));
 break;
case 4:
 //BA.debugLineNum = 72;BA.debugLine="Button12.Text = \"[\" & codigo & \"] \" & sala";
mostCurrent._button12.setText((Object)("["+_codigo+"] "+_sala));
 break;
case 5:
 //BA.debugLineNum = 74;BA.debugLine="Button13.Text = \"[\" & codigo & \"] \" & sala";
mostCurrent._button13.setText((Object)("["+_codigo+"] "+_sala));
 break;
case 6:
 //BA.debugLineNum = 76;BA.debugLine="Button14.Text = \"[\" & codigo & \"] \" & sala";
