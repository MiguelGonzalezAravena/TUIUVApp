...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout(\"Login\")";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 36;BA.debugLine="Msgbox(\"Accediendo\", \"Iniciando sesión\")";
anywheresoftware.b4a.keywords.Common.Msgbox("Accediendo","Iniciando sesión",mostCurrent.activityBA);
