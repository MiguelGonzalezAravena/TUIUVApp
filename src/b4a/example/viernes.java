...
public class viernes extends Activity implements B4AActivity{
	public static viernes mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.viernes");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (viernes).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.viernes");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.viernes", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (viernes) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (viernes) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (viernes) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("Dia_Horario",mostCurrent.activityBA);
 //BA.debugLineNum = 40;BA.debugLine="Label1.Text = \"Viernes\"";
mostCurrent._label1.setText((Object)("Viernes"));
...
mostCurrent._button6.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (82),(int) (155)));
 //BA.debugLineNum = 54;BA.debugLine="Select Case DiaHoy";
switch (BA.switchObjectToInt(mostCurrent._diahoy,"Viernes")) {
case 0:
 //BA.debugLineNum = 56;BA.debugLine="If Hora = 8 AND Minutos >= 30 OR Hora = 9 Then";
if (_hora==8 && _minutos>=30 || _hora==9) { 
 //BA.debugLineNum = 57;BA.debugLine="Button1.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button1.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 59;BA.debugLine="Button2.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button2.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 61;BA.debugLine="Button3.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button3.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 63;BA.debugLine="Button4.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button4.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 65;BA.debugLine="Button5.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button5.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 67;BA.debugLine="Button6.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button6.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 ...
 //BA.debugLineNum = 69;BA.debugLine="Button7.Color = Colors.RGB(253, 183, 39)";
mostCurrent._button7.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (253),(int) (183),(int) (39)));
 };
 break;
}
;
 //BA.debugLineNum = 72;BA.debugLine="Button7.Color = Colors.RGB(0, 82, 155)";
...
_all = "";
 //BA.debugLineNum = 75;BA.debugLine="all = \"dia=4&user=\" & Main.run & \"&passwd=\" & Mai";
_all = "dia=4&user="+mostCurrent._main._run+"&passwd="+mostCurrent._main._passwd;
