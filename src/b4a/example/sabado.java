...
public class sabado extends Activity implements B4AActivity{
	public static sabado mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.sabado");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (sabado).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.sabado");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.sabado", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (sabado) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (sabado) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (sabado) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("Dia_Horario",mostCurrent.activityBA);
 //BA.debugLineNum = 40;BA.debugLine="Label1.Text = \"Sábado\"";
mostCurrent._label1.setText((Object)("Sábado"));
...
switch (BA.switchObjectToInt(mostCurrent._diahoy,"Sábado")) {
case 0:
...
_all = "";
 //BA.debugLineNum = 75;BA.debugLine="all = \"dia=5&user=\" & Main.run & \"&passwd=\" & Mai";
_all = "dia=5&user="+mostCurrent._main._run+"&passwd="+mostCurrent._main._passwd;
