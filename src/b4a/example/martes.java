...
public class martes extends Activity implements B4AActivity{
	public static martes mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.martes");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (martes).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.martes");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.martes", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (martes) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (martes) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (martes) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("Dia_Horario",mostCurrent.activityBA);
 //BA.debugLineNum = 40;BA.debugLine="Label1.Text = \"Martes\"";
mostCurrent._label1.setText((Object)("Martes"));
...
switch (BA.switchObjectToInt(mostCurrent._diahoy,"Martes")) {
case 0:
...
_all = "";
 //BA.debugLineNum = 75;BA.debugLine="all = \"dia=1&user=\" & Main.run & \"&passwd=\" & Mai";
_all = "dia=1&user="+mostCurrent._main._run+"&passwd="+mostCurrent._main._passwd;
