...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 36;BA.debugLine="Activity.LoadLayout(\"Calendario\")";
mostCurrent._activity.LoadLayout("Calendario",mostCurrent.activityBA);
 //BA.debugLineNum = 37;BA.debugLine="Msgbox2(\"Falta por implementar\", \"¡Atención!\", \"A";
anywheresoftware.b4a.keywords.Common.Msgbox2("Falta por implementar","¡Atención!","Aceptar","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 38;BA.debugLine="If DialogResponse.POSITIVE Then StartActivity(Ini";
...
public static boolean  _connected() throws Exception{
 //BA.debugLineNum = 18;BA.debugLine="Sub Connected As Boolean";
 //BA.debugLineNum = 19;BA.debugLine="x.Initialize(0,\"\")";
_x.Initialize(processBA,(int) (0),"");
 //BA.debugLineNum = 20;BA.debugLine="If x.GetMyIP = \"127.0.0.1\" Then";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Dim x As ServerSocket";
